 ...
 * @LastEditTime: 2020-03-26 15:36:24
 */
"use strict";
import "./style.css";
...
let app = angular.module('app', ['ui.router', 'oc.lazyLoad', 'ui.bootstrap', 'ngAnimate', 'ngCookies', 'ngResource', 'ngSanitize', 'ngTouch', services.name, filters.name, directives.name, constants.name, ajaxAddress.name, ajaxService.name, BootstrapController.name])
