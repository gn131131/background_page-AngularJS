 ...
 * @LastEditTime: 2020-04-03 18:04:20
 */
"use strict";
import "./style.css";
...
let app = angular.module('app', ['ui.router', 'oc.lazyLoad', 'ui.bootstrap', 'ngAnimate', 'ngCookies', 'ngResource', 'ngSanitize', 'ngTouch', 'ngMockE2E', services.name, filters.name, directives.name, constants.name, ajaxAddress.name, ajaxService.name, BootstrapController.name])
