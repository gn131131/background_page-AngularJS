 ...
 * @LastEditTime: 2020-03-16 18:57:08
 */
export default angular
  .module('app.ui.bootstrap.controller', [])
  ...
  .controller('CarouselDemoCtrl', ['$scope', 'DATA_BASE', function($scope, DATA_BASE) {
    $scope.myInterval = 5000;
    var slides = $scope.slides = [];
    $scope.addSlide = function() {
      slides.push({
        image: DATA_BASE.commonImages[`c${slides.length}`],
